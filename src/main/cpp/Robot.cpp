...
//--------------------lala------------------------------
  ...
  case 3:
    ...
    std::this_thread::sleep_for(std::chrono::milliseconds(100)); //90 degree turn
    Drive(driveSpeed, driveSpeed, false);
    std::this_thread::sleep_for(std::chrono::milliseconds(1500)); //probably crashed by now
    m_angle.Set(1);
    Drive(driveSpeed, driveSpeed, false);
    ...
    m_angle.Set(-1);
    Drive(-driveSpeed, -driveSpeed, false);
    std::this_thread::sleep_for(std::chrono::milliseconds(250)); //reverse and arm up
    m_angle.Set(0);
    Drive(driveSpeed, -driveSpeed, false);
    std::this_thread::sleep_for(std::chrono::milliseconds(100)); //90 degree turn
    Drive(driveSpeed, driveSpeed, false);
    ...
    Drive(driveSpeed, -driveSpeed, false);
    std::this_thread::sleep_for(std::chrono::milliseconds(200)); //180 ?
    Drive(0,0,true);
    break;
    default:
    std::cout << "idiot";
